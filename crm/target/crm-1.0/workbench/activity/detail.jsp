				...
				success:function (data) {
					...
					* */
					...
					if (data.success){
						...
						html+='<font color="gray">市场活动</font> <font color="gray">-</font> <b>${data.ar.name}</b> <small style="color: gray;"> '+(data.ar.createTime)+'由'+(data.ar.createBy)+'</small>';
	...
	function deleteRemark(id) {
		...
		$.ajax({
			...
			success:function (data) {
				 ...
				 */
				if (data.success){
					//这种做法不行，它是使用的是before方法，每一次删除以后就会保留原有的数据
					//showRemarkList();
					$("#"+id).remove();
