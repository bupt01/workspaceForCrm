...
public class ClueServiceImpl implements ClueService {
    ...
    public boolean convert(String clueId, Tran t, String createBy) {
        ...
        //通过线索对象提取客户信息，当客户不存在的时候，新建客户(根据公司的名称精确匹配)
        ...
        //-------------------
        //经过第三步的处理后，联系人的信息我们已经拥有了，将来在处理其他表的时候，如果使用
        //时候，如果使用到联系人id，直接getid
        ...
        //查询出与该条线索关联的市场活动，查询与市场活动关联的关系的列表
        ...
        for (ClueActivityRelation clueActivityRelation : clueActivityRelationList) {
            ...
            //创建联系人与市场活动的关联关系对象，让第三部生成的联系人与市场活动相关联
        ...
        //如果有创建交易的的需求，我们创建一个交易
        if (t != null) {
            /*
            t在contaoller已经封装好了！
            id，money，等
            接下来可以通过第一步生成的对象，取出一些信息
